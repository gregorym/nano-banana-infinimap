      ...
      <Tooltip.Provider delayDuration={300}>
        {!exists ? (
          ...
          <Tooltip.Root>
            ...
            <Tooltip.Portal>
              <Tooltip.Content
                className="bg-gray-900 text-white px-2 py-1 rounded text-xs leading-none z-[10002]"
                sideOffset={5}
              >
                Generate new tile
            ...
            <Tooltip.Root>
              <Tooltip.Trigger asChild>
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path
                      d="M2 8a6 6 0 1 0 6-6v3m0-3L5 5"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      strokeLinecap="round"
            ...
            <AlertDialog.Root open={deleteOpen} onOpenChange={setDeleteOpen}>
              ...
              <AlertDialog.Portal>
                ...
                <AlertDialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-2xl p-6 w-[90vw] max-w-[450px] max-h-[85vh] z-[10001]">
                  <AlertDialog.Title className="text-lg font-semibold text-gray-900 m-0">
                    Delete Tile?
                  </AlertDialog.Title>
                  <AlertDialog.Description className="mt-2 mb-5 text-sm text-gray-600 leading-relaxed">
                    This will permanently delete the tile at position ({x}, {y}
                    ). This action cannot be undone.
                  </AlertDialog.Description>
                  <div className="flex gap-2 justify-end">
                    <AlertDialog.Cancel asChild>
                      <button
                        className="px-4 py-2 rounded text-sm font-medium bg-gray-100 hover:bg-gray-200 text-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        disabled={loading}
                      >
                        Cancel
                      </button>
