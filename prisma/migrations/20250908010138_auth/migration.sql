...
*/
-- DropForeignKey
ALTER TABLE "public"."Map" DROP CONSTRAINT "Map_user_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."UserMap" DROP CONSTRAINT "UserMap_user_id_fkey";

-- AlterTable
ALTER TABLE "public"."Map" DROP COLUMN "user_id",
ADD COLUMN     "userId" TEXT NOT NULL;

-- AlterTable
ALTER TABLE "public"."UserMap" ALTER COLUMN "user_id" SET DATA TYPE TEXT;
